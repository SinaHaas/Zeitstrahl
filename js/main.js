...
let bild1 = {
    ...
    nameZwei: "69 v.Chr.",
    id: "Kleopatra",
    array: ["Kelopatra wurde 69 v. Chr. in Alexandria geboren. Sie war das dritte von fünf Kindern des ägyptisch-hellenistischen Pharaos Ptolemaios XII (um 110 – 51 v. Chr.), einem König der makedonisch-griechischen Ptolomäer-Dynastie. Diese wurde als Folge der Eroberung Ägyptens durch Alexander dem Großen 332 v. Chr. seit 323 v. Chr. in Ägypten eingesetzt. Kleopatras Mutter ist den Historikern nicht bekannt, es wird allerdings angenommen, dass sie eine adelige Dame Ägyptens war.",
        "Kurz vor seinem Tod ernannte der Vater Kleopatras sie zu seiner Mitregentin (52 v. Chr.). Zusammen mit ihrem 10jährigen Bruder besteigt sie, nach dem Tod ihres Vaters, den Thron 51 v. Chr. Zu diesem Zeitpunkt war Agypten ein Satellietenstaat Roms. Nach ägyptischer Tradition ging sie mit ihrem Bruder eine Geschwisterehe ein. Ihre Regierungszeit war von Machtkämpfen bestimmt, was schlussendlich dazu führte, dass die Berater ihres Bruders sie aus der Regentschaft drängten und sie schlussendlich sogar das Land verlassen musste 49.v.Chr.",
        "Von Palästina aus führte sie mit Hilfe von Söldner Krieg gegen die Berater ihres Bruders. Gleichzeitig herrschte in Ägypten ein Bürgerkrieg. Julius Cäsar konnte diesen Krieg für sich entscheiden und wurde 48. v. Chr. zum Militärherrscher Ägyptens. Im Konflikt zwischen Kleopatra und Ptolemaios XIII. riss er die Schiedsgerichtsbarkeit an sich. Kleopatra landete heimlich in Alexandria und gelangte in einem Sack versteckt in den Palast von Caesar. Der mächtige Römer zeigte sich von der listenreichen Kleopatra beeindruckt und begann eine Affäre mit ihr.",
        "Die Berater des Königs fürchteten um ihre Macht und riefen den fünf Monate andauernden Alexandrischen Krieg aus (48/47 v. Chr.).  Cäsar gewann diesen Konflikt jedoch. Bei diesem soll die berüchtigte Bibliothek von Alexandria in Flammen aufgegangen sein. Kleopatra wurde daraufhin zur Herrscherin über Ägypten durch Roms Gnaden. Ihr Bruder war als formeller Mitherrscher an ihrer Seite, hatte jedoch nicht viel Verantwortung. Kleopatra bekam im Sommer 47 v. Chr. ein von Caesar als Sohn anerkanntes Kind, das Caesarion genannt wurde.",
        "Cäsar stützt ihre Macht in Ägypten und Kleopatras Einfluss auf ihn wächst stetig. 44 v. Chr. fällt Caesar einem Attentat zum Opfer. Kleopatra hat damit ihren wichtigsten Rückhalt in Rom, wo sofort blutige Kämpfe um die Caesar-Nachfolge ausbrachen, verloren. In diesen Konflikten kam es zu einer Auseinandersetzung zwischen zwei Nachlassverwaltern Cäsars, Octavian und Marcus Antonius. Dieser Machtkampf um die Herrschaft Roms dauerte zehn Jahre an und auch Ägypten war betroffen.",
        "Kleopatra, die nach dem Tod ihres Bruders zur ägyptischen Alleinherrscherin aufgestiegen war, schlug sich in diesem Konflikt auf die Seite von Antonius. 41 v. Chr. wurde sie dessen Geliebte. Im Jahr darauf kamen die gemeinsamen Zwillinge Alexander Helios und Kleopatra Selene zur Welt. 36 v. Chr. kam Sohn Ptolemaios Philadelphos hinzu. Ägypten konnte in diesen Konflikten seine Grenzen erweitern und Kleopatra gewann an Ansehen und Macht. Auch ihre Eigendarstellung wurde immer gewagter und gipfelte daran, dass sie sich als Verkörperung der Göttin Isis darstellte.",
        "Doch der Konflikt von Octavian, der das westliche Imperium beherrschte und Antonius, der im Osten herrschte, brach in einem finalen Machtkampf aus, den Octavian für sich entscheiden konnte. In einer Seeschlacht von Actium besiegte Octavian 31 v. Chr. die verbündeten Flotten von Kleopatra und Antonius. Antonius und Kleopatra leisteten noch ein Jahr Widerstand, doch war der Krieg 30 v. Chr. Endgültig verloren.",
        "Antonius brachte sich selbst um und starb in Kleopatras Armen. Es heißt, dass Kleopatra seinen Tod provoziert haben soll, um sich selbst eine bessere Verhandlungsbasis mit Octavian zu ermöglichen. Dieser verhaftete sie trotzdem. Die zu diesem Zeitpunkt 39-jährige Kleopatra, nahm sich am 12. August (nach heutiger Zeitrechnung) des Jahres 30 v. Chr. in Alexandria das Leben. Man munkelt, dass sie sich mit Schlangengift getötet haben soll, dies ist jedoch nicht bewiesen und strittig.",
        "Ihr Sohn Caesarion wurde später von Oktavian getötet, da dieser als Rivale hätte angesehen werden können. Sie wurde in ihrem Mausoleum in Alexandria neben Antonius bestattet. Mit Kleopatras Tod wurde Ägypten endgültig zu einer Provinz Roms, mit Sonderstatus. Kleopatra ging mit ihrem Einfluss auf den mächtigsten Herrscher Roms und ihren Einfluss auf Ägypten in die Geschichte ein."]
};
let bild2 = {
...
let bild3 = {
    ...
    array: ["Queen Elisabeth wurde am 7.September 1533 in Greenwich, London in England geboren. Queen Elizabeth Tudor war die mächtigste Herrscherin im 16. Jahrhundert und prägte diese Zeit, welche später als das Elisabethanische Zeitalter (1558-1603) in die Geschichte eingehen sollte. Sie gründete die Anglikanische Kirche und siegte 1588 über die spanische Armada, was das Fundament für Englands zukünftige Seemacht war. Sie verstarb am 24.März 1603 mit 69 Jahren in Richmond, London.",
        ...
        "Als Queen Mary zum Katholizismus zurückkehrte richteten sich die Augen der Opposition auf Elisabeth. Obwohl diese zu keiner Zeit selber tätig wurde, warf man sie 1554 für acht Wochen in den Tower von London. Da es jedoch keine Beweise für ihr Mitwirken gab, wurde sie mangels Beweise wieder entlassen und gelangte in die Obhut Sir Henry Bedingfields. Erst im April 1555 kehrte sie an den Hof zurück. Nach dem Tode von Queen Mary (1558) wurde Elisabeth Königin. Der 15.01.1559 war das Datum der Krönung.",
        "Mary Stuart rief sich ebenfalls als Königin aus, da sie sich bei den Katholiken als rechtmäßige Nachfolgerin von Henry dem VIII sah, scheiterte damit allerdings. Nach einem Komplott gegen Elisabeth, wurde Mary Stuart von der Regierung hingerichtet, auch wenn Elisabeth diese Entscheidung nicht selbst traf.",
        "Unter Elisabeth und die Schaffung der anglikanischen Staatskirche, wurde England zur protestantischen Vormacht in Europa. Viele am Hof waren der Königin sehr zugetan, darunter auch einige Verehrer wie Christopher Hatton oder Walter Raleigh, der in Nordamerika einen Staat Virginia nach ihr benannte. Nach einer beinahe tödlichen Pockenerkrankung ernannte sie Robert Dudley zum Protector des Königreiches, falls ein solcher Fall erneut eintreten sollte. Sie stand diesem sehr nahe und war ihm zugetan.",
        ...
        "Sie ernannte niemals einen Nachfolger, wusste jedoch, dass der Sohn ihrer ehemaligen Rivalin Mary Stuart vom damaligen Regierungschef bevorzugt wurde. Elisabeth starb am 24.03.1603 als Letzte der Familie Tudor und als eine Frau, die einem ganzen Zeitalter seinen Namen gegeben hat."]
};
let bild4 = {
    name: "./styles/fotos/anne-bonny.jpg",
    nameZwei: "1698",
    id: "Anne Bonny",
    array: ["Anne Bonny und ihre Crew sind als legendäre Piraten der Karibik in die Geschichte eingegangen. Das Geburtsjahr von Anne Bonny wird auf 1698 geschätzt. Die historische Korrektheit der folgenden Fakten ist nicht mehr zu belegen und entstammen alle dem Buch - A General History of the Pyrates: from their first rise and settlement in the island of Providence, to the present time -, welches Daniel Defoe geschrieben haben soll.",
        "Bonny war die Tochter einer Magd, welche zusammen mit ihrem Arbeitgeber William Cormac (Jurist) ein Kind bekam. Zur damaligen Zeit bedeutete eine Bastardtochter große Schande für eine Familie, weshalb ihr Vater versuchte sie zu verheimlichen, indem er Bonny als Jungen verkleidete und als entfernten Verwandten ausgab. Der Schwindel flog jedoch schnell auf und die Familie zog in die britischen Kolonien, (heute USA) nach South Carolina. Dort entwickelte sich das Leben der Familie sehr gut und das kaufmännische Verständnis des Vaters machte diesen zu einem reichen Plantagenbesitzer.",
        "Anne war dieses Leben allerdings zu langweilig und sie trieb sich des Öfteren im örtlichen Hafen herum, wo sie zwielichtigen Gestalten begegnete. Sie traf dort auch auf ihren zukünftigen Ehemann James Bonny. Nach der Heirat verstieß sie ihr Vater. Daraufhin reisen die beiden in die Piratenhochburg New Providence (Nassau). Dort verließ Bonny ihren Mann, um bei dem Piraten Charles Vane anzuheuern. Sie traf außerdem auf Calico Jack Rackham der auf dem Schiff der Steuermann war. Da sie als Frau auf einem Piratenschiff nicht erwünscht war verkleidet sie sich erneut als Mann.",
        "Zusammen mit Calico Jack Rackham setzte sie Vane erst ab, dann aus und die beiden zogen mit einem eigenen Schiff allein los. Mark Read heuerte auf diesem Schiff an. Bei Read handelte es sich jedoch ebenfalls um eine Frau, Mary Read. Zusammen ziehen die drei plündernd durch die Karibik und werden schnell zu einem berüchtigten Trio. Bonny wurde das erste Mal schwanger und lies das Kind auf Kuba zurück. Wenn man den Geschichten Glauben schenkt, soll das Kind von Calcio Jack Rackham gewesen sein.",
        "1720 wurde das Schiff (die Revenge) von einem englischen Kriegsschiff angegriffen und abgesehen von den beiden Frauen, war die Crew so betrunken, dass sie sich unter Deck versteckte. Die beiden Frauen kämpften also allein. Als dann der Kampf bereits verloren war, soll Bonny auf ihre eigenen Männer geschossen haben. Am 16.November 1720 wurde dann das Urteil über die Piratenbande gefällt. Der Tod durch den Strick sollte ihr Schicksal sein.",
        "Anne Bonny war zu diesem Zeitpunkt erneut schwanger, weshalb die Hinrichtung aufgeschoben wurde. Auch Mary Read war schwanger, jedoch starb sie kurz darauf an einem Fieber. Calcio Jack Rackham starb allein durch den Strick. Anne Bonnys Schicksal ist ab diesem Zeitpunkt nicht mehr bekannt. Doch ging sie als eine der berühmtesten Piratinnen in die Geschichte ein."]
};
let bild5 = {
    name: "./styles/fotos/katharina.jpg",
    nameZwei: "1729",
    id: "Katharina die Große",
    array: ["Katharina die Große wurde am 2. Mai 1729 in Stettin in Pommern (heute Polen) geboren. Sophie Auguste Friederike von Anhalt-Zerbst (Geburtsname) war eine bedeutende Zarin bzw. Kaiserin des Russischen Reiches (1762–1796). Sie war Herzogin von Holstein-Gottorf. In der zweiten Hälfte des 18. Jahrhunderts lenkte sie die Geschicke Russlands und nahm großen Einfluss auf die europäische Politik. Sie trägt als einzige Frau den Beinamen „die Große“. Sie verstarb mit 67 Jahren am 17. November 1796 (Gregorianischer Kalender, am 6. November 1796 nach julianischem Kalender) in Sankt Petersburg in Russland.",
        ...
        "Trotzdem wollte sie am russischen Hof Einfluss gewinnen und Russland wirtschaftlich, wie auch politisch mit dem modernen Westeuropa gleichsetzen. Sie lernte heimlich über Politik und Wirtschaft, gab sich am Hofe jedoch als lediglich als interessiertes Mädchen. Katharina soll außerdem 21 Liebhaber gehabt haben. Am 20.09.1745 gebar Katharina ihren ersten Sohn Paul. Obwohl vermutlich ihrer Affäre mit Sergej Saltykow entstammend, wurde das Kind als ehelich anerkannt. Nach der Geburt übernahm Zarin Elisabeth das Kind an sich, was sich negativ auf die Beziehung der beiden Frauen auswirkte. Sie brachte außerdem eine Tochter, Anna zur Welt, diese verstarb jedoch sehr jung.",
        "Zarin Elisabeth verstarb am 25.12.1761 und Peter Fjodorowitsch, Katharinas Ehemann, bestieg als Zar Peter III. den russischen Thron. Mit der Politik des Gatten nicht einverstanden, beschließt sie 1762 zu handeln. Zusammen mit dem Kommandanten Alekseij Orlow, mit dessen Bruder sie eine Affäre hatte, gelang es ihr mithilfe der russischen Armee Peter III. am 28.06.1762 vom Thron zu stürzen. Daraufhin ließ sie sich selbst in Petersburg zur Zarin proklamieren.",
        "Ihr Ehemann wurde später im Gefängnis von Alekseij Orlow ermordet. Katharina veranlasste jedoch nie eine Untersuchung, da sie auf die Unterstützung Orlows und dessen Armee angewiesen war. So erhielt sie den Ruf der Gattenmörderin. Am 22.09.1762 wurde sie in Moskau zur Zarin Katharina II. von Russland gekrönt und zur absoluten Herrscherin über das größte europäische Imperium erklärt.",
...
let bild6 = {
    ...
    array: ["Luise Auguste Wilhelmine Amalie von Preußen wurde am 10. März 1776 in Hannover im Heiligen Römischen Reich (heute Deutschland) geboren. Sie war die Ehefrau von König Friedrich Wilhelm III. und damit die Königin von Preußen (1797–1810). Sie wurde im Widerstand gegen Napoleon Bonaparte zur Symbolfigur zur „Königin der Herzen“. Sie starb am 19. Juli 1810 mit nur 34 Jahren auf Schloss Hohenzieritz.",
        "Mit nur sechs Jahren erlebt Luise wie ihre Mutter stirbt. Zusammen mit ihren zwei Schwestern verbringt sie ab 1786 einen Großteil ihrer Kindheit bei der Großmutter in Darmstadt. Diese Kindheit ist unbeschwert und sehr glücklich. Durch ihre frische und unbeschwerte Art viel sie auf, sie war unpünktlich und naschte gerne. Mit sechzehn Jahren wurde Luise in die Gesellschaft eingeführt, davor lebte sie beinahe bürgerlich, was sie sehr bescheiden werden ließ.",
        ...
        "Luise war an Politik vorerst nicht interessiert, dies änderte sich jedoch im Jahr 1804. Den stärksten Einfluss auf ihr politisches Bewusstsein hatte Napoleon, ihr größter Feind. Dieser verletzte immer weitere vertragliche Rechte Preußens. Einer ihrer ersten politischen Partner war der preußische Außenminister Hardenberg. Sie stand ihrem eher zweifelnden und unentschlossenen Ehemanne stets zur Seite und drängte darauf, die Kontakte mit dem französischen Kaiser abzubrechen.",
        "1806 wird Preußen in einem Bündnisvertrag mit Frankreich Hannover angeboten, doch Luise sieht dieses Bündnis skeptisch. In einem Brief an ihren Ehemann schrieb sie „Napoleon ist ein Schuft!“ und wurde somit zur Symbolfigur des Widerstands. Als das preußische Heer 1806 bei Jena und Auerstedt vernichtend geschlagen wurde, floh die königliche Familie mit den Kindern nach Königsberg in Ostpreußen. Geknebelt durch die riesigen Kontributionszahlungen an Frankreich, befand sich Preußen damals in einer katastrophalen Lage.",
...
let bild7 = {
    ...
    array: ["Elisabeth Amalie Eugenie von Österreich-Ungarn war als Ehefrau von Franz Joseph I. Kaiserin von Österreich (ab 1854). Sie wurde u. a. durch mehrere Filme im 20. Jahrhundert zu einem weltweiten Idol. Sie wurde am 24. Dezember 1837 in München geboren und verstarb mit 60 Jahren am 10. September 1898 in Genf in der Schweiz.",
        ...
        "Nach dem Selbstmord ihres Sohnes Rudolf, versank Sisi nur noch tiefer in Depressionen. Im Frühherbst 1898 verbrachte Sisi einige Tage am Genfer See. Am 10. September wurde Sisi von einem fremden Mann eingeholt und niedergestochen. Sie starb daraufhin. Sie wurde in der Kapuzinergruft in Wien bestattet."]
};
let bild8 = {
...
let bild9 = {
    ...
    array: ["Amelia Earhart war eine US-amerikanische Flugpionierin, Schriftstellerin und Frauenrechtlerin. Sie flog unter anderem 1932 als erste Frau allein über den Atlantik. 1937 ist sie bei dem Versuch einer Weltumrundung mit dem Flugzeug verschollen.",
        "Sie wurde am 24.Juli 1897 in Atchison, Kansas in den Vereinigten Staaten geboren. Mit nur 39 Jahren verstarb sie am 2. Juli 1937 auf der Route zur Howland Island, United States Minor Outlying Islands.",
        "Gegen Ende des ersten Weltkriegs arbeitete sie als Tochter eines deutsch-amerikanischen Juristen als Militärkrankenschwester in Toronto. Dort entdeckte sie ihre Leidenschaft für Flugzeuge, da in der Nähe Flieger trainierten. 1920 bekam sie das erste Mal die Chance, in einem Flugzeug mitzufliegen: „In dem Moment als wir den Boden verließen, wusste ich: Ich selbst musste fliegen“, schrieb sie in ihrer Autobiografie „The fun of it“ (1932).",
        "Bekanntheit erlangte sie das erste Mal als sie als erste Passagierin an einem Nonstop-Flug über den Atlantik teilnahm. Es gefiel ihr allerdings nicht als „zusätzliches Gewicht“ an Bord zu sein.",
        ...
        "Die US-Regierung startete eine aufwendige Rettungsaktion. Nachdem bis zum 19. Juli 400.000 Quadratkilometer abgesucht worden waren, wurden Earhart und Noonan für tot erklärt. Ihr Schicksal liefert seitdem Stoff für Legenden. Wahrscheinlich ist, dass fehlerhafte Funkpeilung die Crew das winzige Eiland verfehlen ließ. Die Pilotin sollte als Figur der Frauenrechtsbewegung und als Flugpionierin in die Geschichte eingehen."]
};
let bild10 = {
    name: "./styles/fotos/Astrid_Lindgren.jpg",
    nameZwei: "1907",
    id: "Astrid Lindgren",
    array: ["Astrid Anna Emilia Lindgren war eine schwedische Schriftstellerin und eine der bekanntesten Kinderbuchautorinnen der Welt. Sie ist Schöpferin beliebter Kinderhelden wie „Pippi Langstrumpf“, „Michel aus Lönneberga“, „Ronja Räubertochter“ und „Kalle Blomquist“. Sie wurde am 14. November 1907 in Vimmerby in Schweden geboren und verstarb mit 94 Jahren am 28. Januar 2002 in Stockholm.",
        "Als ihre Tochter krank im Bett lag, erfand Astrid für sie „Pipi Langstumpf“, eine Kinderheldin, die heute weltbekannt ist. Als das Töchterchen schon wieder gesund war, wollte diese trotzdem immer mehr Geschichten von Pipi Langstrumpf hören. So kam es, dass Astrid immer mehr Geschichten schrieb und diese in einem Buch zusammenfasste. Sie schickte das Buch später an einen Verlag. Dadurch wurde Astrid Lindgren die berühmteste Kinderbuchautorin der Welt. Sie erzählt Geschichten, in denen Kinder frech, fröhlich und verrückt sein dürfen – Kinder eben. Auch sie wäre gern ihr Leben lang Kind geblieben.",
        "Sie wurde als zweites von vier Kindern auf einem Hof in der schwedischen Ortschaft Vimmerby geboren. Ihr Geburtsname lautete Astrid Anna Emilia Ericsson. In ihrer Kindheit erlebt Astrid jene Bilderbuchkindheit, die sie in ihren Geschichten über Pippi und die - Kinder von Bullerbü - für immer festhalten wird. Stromern durch Frühlingswiesen, pflücken saftiger Kirschen. Im Winter bewachen Schneemänner das Zuhause.",
        "- Die beste Zeit meines Lebens war, wenn ich spielen durfte. Ich fand es nicht besonders lustig, größer zu werden-, erzählt Astrid später. Und Pippi spricht ihr aus der Seele, wenn diese erklärt, dass Erwachsene langweilig sind.",
        "1924 bot ihr der Chefredakteur ihrer Ortszeitung eine journalistische Ausbildung an. Dort recherchierte sie, schrieb eigene Geschichten und korrigierte Texte. Diese Arbeit bereitete ihr viel Freude.",
        "Als sie im Alter von 18 Jahren überraschend von einem verheirateten Mann schwanger wurde, musste sie die Stadt jedoch verlassen. Astrid zieht von Vimmerby nach Stockholm und fängt dort mit ihrem Sohn Lars ein neues Leben an. Dieser wird jedoch bald an eine Pflegefamilie weitergegeben. Dieser Verlust hat sie zu vielen ihrer späteren Geschichten veranlasst.",
        "Erst vier Jahre später, als die Pflegemutter krank wurde, konnte Astrid ihren Sohn wieder zu sich nehmen. Mittlerweile arbeitete sie als Sekretärin und war mit Sture Lindgren verheiratet. Mit ihm bekam sie 1934 auch die Tochter Karin.",
        "„Wenn ich schrieb“ -, erzählt Astrid, „war ich für alle Sorgen unerreichbar.“ Und Sorgen hatte sie genug: Ihr Mann, ihr Bruder und ihr Sohn sterben. All die traurigen Erlebnisse verarbeitet sie in dem Buch „Die Brüder Löwenherz“.",
        "1981 schrieb Astrid Lindgren mit Ronja Räubertochter das letzte ihrer Kinderbücher. Am 28. Januar 2002 stirbt sie. Doch Astrid, die niemals erwachsen werden wollte, lebt in den Kindern ihrer Geschichten weiter. In Karlsson, Michel, Madita – und in Pippi.",
...
let bild11 = {
    ...
    nameZwei: "1921",
    id: "Sophie Scholl",
    array: ["Sophia Magdalena Scholl wurde am 9. Mai 1921 in Forchtenberg geboren und starb am 22. Februar 1943 mit nur 21 Jahren in München. Sie war eine Widerstandskämpferin gegen die Diktatur des Nationalsozialismus und Mitglied der Gruppe „Weiße Rose“. Diese kämpfte mit Hilfe von Flugblättern gegen die Nationalsozialisten. Nach ihrer Enttarnung wurde Sophie Scholl verhaftet und mit der Guillotine enthauptet.",
        "Sophie kam mit sieben Jahren in die Grundschule. 1932 zog sie mit ihrer Familie nach Ulm und besuchte dort ein Mädchengymnasium. Mit zwölf Jahren trat sie dem Bund Deutscher Mädel (BDM) bei. Die anfängliche Begeisterung wandelte sich in Ablehnung und Kritik um.",
        "Im Frühjahr 1940 machte sie ihr Abitur im Fach Deutsch. Sie begann dann eine Ausbildung zur Kindergärtnerin, in der Hoffnung so dem Reichsarbeitsdienst zu entgehen. Das erwies sich jedoch als Irrglaube denn sie wurde zwangsweise ein halbes Jahr zum Reichsarbeitsdienst und ein weiteres halbes Jahr zum Kriegshilfsdienst verpflichtet.",
        "1942 nahm sie an der Universität München ein Biologie- und Philosophiestudium auf. Im Frühjahr 1942 entschlossen sich Sophie und Hans Scholl zusammen mit ihren Freunden zur höchst illegalen und öffentlichen Kritik am Nationalsozialismus. Sie beteiligten sich an der Herstellung und Verbreitung von Flugblättern der studentischen Widerstandsgruppe “Weiße Rose“. Die Flugblätter verursachten großes Aufsehen und führten 1943 zu einer intensiven Fahndung nach den Verursachern.",
        "Am 18. Februar 1943 verteilten die Geschwister etwa 1700 Flugblätter in der Münchener Universität. Jedoch beobachtete sie der Hausmeister und meldete sie später. Die Geheime Staatspolizei (Gestapo) verhaftete sie. Nach dreitägigem Verhör folgte der Prozess vor dem “Volksgerichtshof“. Am 22. Februar 1943 wurden Sophie und Hans Scholl zusammen mit ihrem Freund Christoph Probst zum Tode verurteilt. Noch am selben Tag wurden sie im Strafgefängnis München-Stadelheim durch das Fallbeil hingerichtet."]
};
let bild12 = {
    name: "./styles/fotos/anne-frank.jpeg",
    nameZwei: "1929",
    id: "Anne Frank",
    array: ["Annelies Marie Frank wurde am 12. Juni 1929 in Frankfurt am Main geboren und starb mit nur 15 Jahren im Februar 1945 im Konzentrationslager Bergen-Belsen. Sie war ein jüdisches deutsches Mädchen das Opfer des Holocaust wurde. Damals versteckte sie sich zusammen mit ihrer Familie in einem Amsterdamer Hinterhaus vor den Nationalsozialisten. Jedoch wurde sie kurz vor Kriegsende deportiert. Ihre Geschichte wurde durch ihren Vater Otto Frank in Form ihres alten Tagebuchs veröffentlicht.",
        ...
        "Ihre Familie lebte schon immer in Deutschland und war Teil des jüdischen Glaubens. Als im Jahr 1933 die nationalsozialistische Partei von Adolf Hitler an die Macht kam, wurde das Leben der Juden in Deutschland immer schwieriger. Auch Annes Familie beschloss 1933 Deutschland zu verlassen. Als sie vier Jahre alt war, wanderten die Eltern mit ihr und ihrer Schwester Margot in die Niederlande aus. In Amsterdam konnte die Familie zunächst einige unbeschwerte, glückliche Jahre verbringen.",
        "Am 10. Mai 1940 marschierten deutsche Truppen in den Niederlanden ein. Annes Familie konnte sich vorerst verstecken. Gemeinsam mit einer weiteren jüdischen Familie versteckten sie sich im Hinterhaus des ehemaligen Geschäfts von Annes Vater. Angst war in dieser Zeit jedoch ihr ständiger Begleiter. Zu dieser Zeit war Anne erst 12 und begann, ihre Gedanken, Gefühle, Ängste und Erlebnisse in einem Tagebuch niederzuschreiben.",
        "Am 4. August 1944 wurde das Hinterhaus von der Polizei gestürmt. Zuerst wurden sie ins nächstgelegene Lager gebracht. Von dort aus ging es weiter in das Vernichtungslager Auschwitz in Polen. Anne Frank, ihre Mutter und ihre Schwester Margot gelangten zunächst nach Bergen-Belsen bei Celle.",
        "Die Niederlage der deutschen Armee war nicht mehr weit weg und die Hoffnung auf ein baldiges Ende des Krieges wuchs. Doch nur wenige Wochen, bevor der Krieg zu Ende war und die Gefangenen aus den Konzentrationslagern befreit wurden, bekamen Anne und Margot Typhus. Beide starben kurz nacheinander im März 1945 an dieser schweren Krankheit.",
        "Der einzige Überlebende der Familie war Otto Frank, Annes Vater. 1947 veröffentlichte Otto Frank die Aufzeichnungen seiner Tochter. Das Buch wurde bisher in 55 Sprachen übersetzt und ist eines der meistgelesenen Werke der Welt. Erst 2009 wurde es von der UNESCO in das Weltdokumentenerbe aufgenommen."]
};
let bild13 = {
...
let bild14 = {
    ...
    nameZwei: "1934",
    id: "Jane Goodall",
    array: ["Dame Valerie Jane Morris Goodall wurde in den 1930er-Jahren am 3. April 1934 in London geboren. Sie ist eine berühmte britische Verhaltensforscherin, die seit 1960 in Tansania das Verhalten von Schimpansen untersucht. Sie ist dieses Jahr 87 Jahre alt geworden.",
        ...
        "Jane Goodall wuchs an der Südküste Englands in Bournemouth auf. Sie begann schon früh sich für Lebewesen in ihrer Umgebung zu interessieren. Sie nahm Regenwürmer mit in ihr Zimmer oder schaute stundenlang einem Huhn beim eierlegen zu. Ihre Mutter Vanne Goodall unterstützte die Leidenschaft ihrer Tochter. Sie träumte davon einmal in Afrika mit exotischen Tieren zu leben.",
        "Nach Abitur und Handelsschule arbeitete sie als Sekretärin bei einem Dokumentarfilmproduzenten. Mit 23 Jahren folgte sie der Einladung einer Freundin nach Kenia (1957). Um in Kenia bleiben zu können, arbeitete sie wieder als Sekretärin in Nairobi. Sie hörte von dem Paläontologen und Anthropologen Louis Leakey, der in der Nähe nach der fossilen Herkunft der Menschen suchte und traf sich mit ihm. Dieser erkannte ihre Begeisterung für Afrika und Tiere sofort. Daraufhin beschäftigte er sie als Sekretärin bei seinen Ausgrabungen in der berühmten Olduvai-Schlucht.",
        "Er interessierte sich für die Schimpansen am Ufer des Tanganjika-Sees, da er sich über sie weitere Kenntnisse zu den menschlichen Vorfahren erhoffte. Er schlug Jane eine Feldstudie über die Schimpansen vor. Das war die Chance, auf die sie so gewartet hatte.",
        "1960 fuhren sie in das Gebiet des heutigen Gombe Nationalparks in Tansania und Jane begann mit ihren Forschungen. Später sollten diese sie weltweit berühmt machen. Die Forschungen dauern bis heute an. 1960 konnte Jane Goodall zum ersten Mal die Herstellung von Werkzeug bei Schimpansen beobachten. Diese sensationelle Entdeckung stellte die vorherrschende Definition vom Menschen als alleinigem Werkzeughersteller auf den Kopf.",
        "Durch diese Erkenntnisse verringerte sich die Kluft zwischen Schimpansen und Menschen. Sie entdeckte außerdem, dass Schimpansen keine reinen Pflanzenfresser sind, sondern Fleisch essen, also wie der Mensch omnivor leben.",
        ...
        "Nie gab Jane Goodall den Schimpansen Nummern, wie es damals üblich war, sondern Namen, da für sie immer klar war, das die Schimpansen logisch denken und Gefühle haben. Damit machte sie sich in der Wissenschaft erst mal unbeliebt, konnte sich aber durchsetzen und mittlerweile ist es eine anerkannte Methode in der beobachtenden Verhaltensforschung. Ein wichtiger Schritt zum respektvollen Umgang mit den Tieren.",
        "Dieser Umgang ist ihr bis heute sehr wichtig. Sie setzt sich auf der ganzen Welt mit Begeisterung für die Tiere, die Natur, und damit auch für den Menschen ein und zeigt, in vielen verschiedenen Projekten und Organisationen, dass jeder, dazu beisteuern kann unseren Planeten mit seinen vielfältigen Lebewesen zu erhalten.",
        ...
        "Jane Goodall hat über 30 Sach- und Kinderbücher geschrieben, sowie unzählige Beiträge in wissenschaftlichen Publikationen und Vorwörter in mehr als 100 Büchern anderer Autoren. Bekannt wurde insbesondere ihr Buch „Wilde Schimpansen“, das 1971 erschien. In jüngster Zeit machten die Bestseller „Grund zur Hoffnung“ (1999) und „Africa in my Blood“ (2000) auf sich aufmerksam."]
};
let bild15 = {
    name: "./styles/fotos/Malala_Yousafzai.jpg",
    nameZwei: "1997",
    id: "Malala Yousafzai",
    array: ["Malala Yousafzai ist eine pakistanische Menschenrechtsaktivistin, die sich beachtet schon als Schülerin gegen die Unterdrückung und für das Recht auf Bildung einsetzte. 2012 wurde sie bei einem Attentat der Taliban schwer verletzt und 2014 erhielt sie den Friedensnobelpreis. Sie wurde am 12. Juli 1997 in Mingora in Pakistan geboren.",
        "Bis zu ihrem elften Lebensjahr, verbrachte sie ein - für pakistanische Verhältnisse - normales Leben. 2007 übernahmen die Taliban die Herrschaft über Malalas Heimat. Die radikalen Islamisten stehen oft im Zusammenhang mit Terrorismus und werden verdächtigt, an den Anschlägen auf das World Trade Center in den USA beteiligt gewesen zu sein. Ihr Ziel ist es einen Gottesstaat zu errichten. Dazu gehört, dass Frauen in der Öffentlichkeit Ganzkörperschleier tragen müssen, nicht arbeiten dürfen und ab einem Alter von acht Jahren nicht mehr zur Schule gehen sollen.",
        "Diese Unterdrückung der Frauen war Thema der Webseite des TV-Senders BBC. Malalas Vater, Ziauddin Yousafzai, schlug seine Tochter als Autorin für den Blog Gul Makai (Kornblume) vor.",
        "Dort beschrieb Malala in kurzen Notizen zehn Wochen lang, wie die Taliban die Menschen unterdrückten. Sie erzählte von Selbstmordattentaten, Angst und Trauer und auch von Mädchen, die nicht zur Schule gehen durften. Damit wurde sie innerhalb kürzester Zeit berühmt: Sie trat in Fernsehshows auf und gab Interviews zu den Themen Bildung und Frauen. Sie traute sich in die Öffentlichkeit, was wegen den Attentaten nicht selbstverständlich war. Ende Dezember erhielt sie für ihr Engagement den pakistanischen Friedenspreis.",
        "Für die Taliban jedoch war sie eine Bedrohung. Diese wollten sie ruhigstellen. Deshalb stürmten sie im Oktober 2012 den Bus, in dem Malala saß und schossen auf sie. Malala wurde schwer verletzt und musste zuletzt in Großbritannien behandelt werden.",
        "Das furchtbare Attentat hatte für die Taliban den gegenteiligen Effekt: Denn es verhalf der jungen Freiheitskämpferin zu noch mehr Berühmtheit. Malala gilt seither für Frauen weltweit als Symbolfigur für Freiheit und Bildung. Im Jahr 2014 bekam Malala sogar den Friedensnobelpreis.",
        "2017 wurde Malala Yousefzai zur UN-Friedensbotschafterin ernannt. Sie ist mit nur 19 Jahren die jüngste Friedensnobelpreisträgerin der Welt. Am 10. April 2017 verlieh ihr der UN-Generalsekretär António Guterres bei den Vereinten Nationen den Titel."]
};
let bild16 = {
...
let zeichnung = [bild1, bild2, bild3, bild4, bild5, bild6, bild7, bild8, bild9, bild10, bild11, bild12, bild13, bild14, bild15, bild16];
function writeHTML() {
    for (let i = 0; i < zeichnung.length; i++) {
        /*console.log(zeichnung[i]);*/
        // schreibt Frauennamen in die Zeitleiste und erstellt li
        let prodElement = document.createElement("div");
        let gewählt = `<li><p id="${zeichnung[i].id}"> ${zeichnung[i].nameZwei} </p></li>`;
        ...
        let neu = `<img id="vorhanden" src="${zeichnung[0].name}">
        <p>${zeichnung[0].id}</p> 
...
let a = 0;
let b = 0;
let tiktak = document.getElementById("sound");
let error = document.getElementById("audio");
let d = 0;
...
function bildGroß(_event) {
    ...
    if (target.id == "vorwärts") {
        ...
        let gewählt = `<img id="vorhanden" src="${zeichnung[b].name}">
        <p>${zeichnung[b].id}</p> 
